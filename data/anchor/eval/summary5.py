...
def load_quality(bilinear_log, sr_log):
    ...
    with open(bilinear_log, 'r') as f1, open(sr_log, 'r') as f2:
        ...
        for line1, line2 in zip(lines1, lines2):
            ...
            gains.append(bilinear_psnr - sr_psnr)
    gains_per_chunk = []
...
if __name__ == '__main__':
    ...
    for anchor in range(1, 31):
        ...
        # for content in ['lol0']:
            ...
            sr_log_path = os.path.join(log_dir, "720p_4125kbps_d600.webm", 'EDSR_B8_F32_S3', 'quality.txt')
            ...
            gains[content][anchor] = load_quality(sr_log_path, engorgio_log_path)
    with open('720p_margins.json', 'w') as outfile:
