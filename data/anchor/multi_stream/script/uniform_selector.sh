...
python ${ENGORGIO_CODE_ROOT}/engorgio/anchor/multi_stream/uniform_selector.py --data_dir ${ENGORGIO_DATA_ROOT} --num_epochs ${num_epochs} --epoch_length ${epoch_length} \
                                 --avg_anchors ${num_anchors} --video_type ${video_type}